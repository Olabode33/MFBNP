...
namespace PMSDemo.Migrations
{
    ...
    [Migration("20200414170144_Added_ComparisonMethod_and_MeansOfVerification_to_Targets")]
    partial class Added_ComparisonMethod_and_MeansOfVerification_to_Targets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMSDemo.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PMSDemo.Deliverables.PerformanceReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PMSDemo.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PMSDemo.PerformanceActivities.ActivityAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("PerformanceActivityId");

                    b.ToTable("ActivityAttachments");
                });

            modelBuilder.Entity("PMSDemo.PerformanceActivities.ActivityUpdateLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ActivityUpdateLogs");
                });

            modelBuilder.Entity("PMSDemo.PerformanceActivities.PerformanceActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MilestoneAchieved")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("PerformanceActivities");
                });

            modelBuilder.Entity("PMSDemo.PerformanceIndicators.IndicatorAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("IndicatorTargetId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IndicatorTargetId");

                    b.ToTable("IndicatorAttachments");
                });

            modelBuilder.Entity("PMSDemo.PerformanceIndicators.IndicatorUpdateLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("IndicatorUpdateLogs");
                });

            modelBuilder.Entity("PMSDemo.PerformanceIndicators.IndicatorYearlyTarget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("IndicatorYearlyTargets");
                });

            modelBuilder.Entity("PMSDemo.PerformanceIndicators.PerformanceIndicator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("BaselineComment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PMSDemo.PriorityAreas.PriorityArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PMSDemo.Agencies.Mda", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Mda");
                });

            modelBuilder.Entity("PMSDemo.Deliverables.Deliverable", b =>
                {
                    b.HasBaseType("Abp.Organizations.OrganizationUnit");
                    ...
                    b.Property<int?>("PriorityAreaId")
                        .HasColumnType("int");

                    b.HasIndex("PriorityAreaId");

                    b.ToTable("Deliverables");

                    b.HasDiscriminator().HasValue("Deliverable");
                });

            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PMSDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PMSDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PMSDemo.PerformanceActivities.ActivityAttachment", b =>
                {
                    b.HasOne("PMSDemo.Storage.BinaryObject", "Document")
                        .WithMany()
                        .HasForeignKey("DocumentId");

                    b.HasOne("PMSDemo.PerformanceActivities.PerformanceActivity", "PerformanceActivityFk")
                        .WithMany()
                        .HasForeignKey("PerformanceActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PMSDemo.PerformanceActivities.ActivityUpdateLog", b =>
                {
                    b.HasOne("PMSDemo.PerformanceActivities.PerformanceActivity", "PerformanceIndicatorFk")
                        .WithMany()
                        .HasForeignKey("PerformanceActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PMSDemo.PerformanceIndicators.IndicatorAttachment", b =>
                {
                    ...
                    b.HasOne("PMSDemo.PerformanceIndicators.IndicatorYearlyTarget", "IndicatorTargetFk")
                        .WithMany()
                        .HasForeignKey("IndicatorTargetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PMSDemo.PerformanceIndicators.IndicatorUpdateLog", b =>
                {
                    b.HasOne("PMSDemo.PerformanceIndicators.PerformanceIndicator", "PerformanceIndicatorFk")
                        .WithMany()
            ...
            modelBuilder.Entity("PMSDemo.Deliverables.Deliverable", b =>
                {
                    b.HasOne("PMSDemo.PriorityAreas.PriorityArea", "PriorityAreaFk")
                        .WithMany()
                        .HasForeignKey("PriorityAreaId");
                });
