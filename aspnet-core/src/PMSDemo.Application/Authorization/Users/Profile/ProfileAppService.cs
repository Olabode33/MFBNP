...
using PMSDemo.Authorization.Users.Profile.Cache;
using PMSDemo.Authorization.Users.Profile.Dto;
using PMSDemo.Friendships;
using PMSDemo.Gdpr;
using PMSDemo.Identity;
using PMSDemo.Net.Sms;
using PMSDemo.Security;
using PMSDemo.Storage;
using PMSDemo.Timing;

namespace PMSDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PMSDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PMSDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PMSDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
