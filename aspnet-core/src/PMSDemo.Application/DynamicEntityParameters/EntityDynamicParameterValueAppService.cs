...
using PMSDemo.EntityDynamicParameterValues.Dto;

namespace PMSDemo.DynamicEntityParameters
{
    [Authorize(AppPermissions.Pages_Administration_EntityDynamicParameterValue)]
    public class EntityDynamicParameterValueAppService : PMSDemoAppServiceBase, IEntityDynamicParameterValueAppService
    {
