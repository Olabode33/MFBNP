namespace PMSDemo.Authorization
{
    ...
    {
        public const string Pages_MDA = "Pages.MDA";
        public const string Pages_MDA_Create = "Pages.MDA.Create";
        public const string Pages_MDA_Edit = "Pages.MDA.Edit";
        public const string Pages_MDA_Delete = "Pages.MDA.Delete";

        public const string Pages_Deliverable = "Pages.Deliverable";
        public const string Pages_Deliverable_Create = "Pages.Deliverable.Create";
        public const string Pages_Deliverable_Edit = "Pages.Deliverable.Edit";
        public const string Pages_Deliverable_Delete = "Pages.Deliverable.Delete";
        public const string Pages_Deliverable_Review = "Pages.Deliverable.Review";

        public const string Pages_PerformanceIndicator = "Pages.PerformanceIndicator";
        public const string Pages_PerformanceIndicator_Create = "Pages.PerformanceIndicator.Create";
        public const string Pages_PerformanceIndicator_Edit = "Pages.PerformanceIndicator.Edit";
        public const string Pages_PerformanceIndicator_Delete = "Pages.PerformanceIndicator.Delete";
        public const string Pages_PerformanceIndicator_Update = "Pages.PerformanceIndicator.Update";

        public const string Pages_PerformanceActivity = "Pages.PerformanceActivity";
        public const string Pages_PerformanceActivity_Create = "Pages.PerformanceActivity.Create";
        public const string Pages_PerformanceActivity_Edit = "Pages.PerformanceActivity.Edit";
        public const string Pages_PerformanceActivity_Delete = "Pages.PerformanceActivity.Delete";
        public const string Pages_PerformanceActivity_Update = "Pages.PerformanceActivity.Update";

        public const string Pages_PriorityAreas = "Pages.PriorityAreas";
        public const string Pages_PriorityAreas_Create = "Pages.PriorityAreas.Create";
        public const string Pages_PriorityAreas_Edit = "Pages.PriorityAreas.Edit";
        public const string Pages_PriorityAreas_Delete = "Pages.PriorityAreas.Delete";
