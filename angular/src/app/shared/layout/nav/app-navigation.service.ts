...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('MDA', 'Pages.Deliverable', 'flaticon-map', '/app/main/deliverables'),
             new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [], [
                ...
                // new AppMenuItem('DynamicEntityParameters', '', 'flaticon-interface-8', '', [], [
                //     new AppMenuItem('DynamicParameter', 'Pages.Administration.DynamicParameters', '', '/app/admin/dynamic-parameter'),
                //     new AppMenuItem('EntityDynamicParameter', 'Pages.Administration.EntityDynamicParameters', '', '/app/admin/entity-dynamic-parameter'),
                // ])
            ])//,
