...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.PerformanceActivitiesServiceProxy,
        ApiServiceProxies.PerformanceIndicatorsServiceProxy,
        ApiServiceProxies.DeliverablesServiceProxy,
        ApiServiceProxies.MdasServiceProxy,
        ApiServiceProxies.PriorityAreasServiceProxy,
